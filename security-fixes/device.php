...
if (isset($_GET['from'])) {
    ...
    $html_content .= "<option value='" . html_escape($_GET['position']) . "' selected>" . html_escape($_GET['position']) . "</option>";
}
...
<div class="panel panel-default">
    ...
    <div class="panel-body">
        ...
        <div class="form-group">
           ...
           <div class="col-sm-9">
           <input type="text" class="form-control" name="height" id="height" value="', html_escape($mfg->Height), '">
           </div>
        </div>
        <div class="form-group">
           <label class="col-sm-3" for="weight">', __("Weight"), '</label>
           <div class="col-sm-9">
           <input type="text" class="form-control" name="weight" id="weight" value="', html_escape($mfg->Weight), '">
           </div>
        </div>
        <div class="form-group">
           <label class="col-sm-3" for="wattage">', __("Wattage"), '</label>
           <div class="col-sm-9">
           <input type="text" class="form-control" name="wattage" id="wattage" value="', html_escape($mfg->Wattage), '">
           </div>
        </div>
        <div class="form-group">
           <label class="col-sm-3" for="no_power">', __("No. Power Connections"), '</label>
           <div class="col-sm-9">
           <input type="text" class="form-control" name="no_power" id="no_power" value="', html_escape($mfg->No_power), '">
           </div>
        </div>
        <div class="clearfix"></div>
        <div class="form-group">
           ...
           <div class="col-sm-9">
           <input type="text" class="form-control" name="no_port" id="no_port" value="', html_escape($mfg->No_port), '">
           </div>
        </div>
        <div class="clearfix"></div>';
        $rearweb_path = _MEDIA_URL . "devices/" . html_escape($mfg->Rear_picture);
        $frontweb_path = _MEDIA_URL . "devices/" . html_escape($mfg->Front_picture);
        ...
        if (file_exists($rearfilename) && $mfg->Rear_picture != "") {
            $rear_icon = "<a href='" . html_escape($rearweb_path) . "' target='__blank'>" . html_escape($mfg->Rear_picture) . " <i class='fa fa-eye'></i></a>";
        }
        if (file_exists($frontfilename) && $mfg->Front_picture) {
            $front_icon = "<a href='" . html_escape($frontweb_path) . "' target='__blank'>" . html_escape($mfg->Front_picture) . " <i class='fa fa-eye'></i></a>";
        }
        echo '<div class="form-group">
           <label class="col-sm-3" for="front_picture">', __("Front Picture File"), '</label>
           <div class="col-sm-9">
           <input type="file" class="form-control" name="front_picture" id="front_picture" value="', html_escape($mfg->Front_picture), '">
           <output id="filesInfo"></output>
           <input type="hidden" name="front_pic" id="front_pic" value="', html_escape($mfg->Front_pic), '">  
        ...
        <div class="form-group">
           ...
           <div class="col-sm-9">
           <input type="file" class="form-control" name="rear_picture" id="rear_picture" value="', html_escape($mfg->Rear_picture), '">
            <output id="rearfilesInfo"></output>   
            <input type="hidden" name="rear_pic" id="rear_pic" value="', html_escape($mfg->Rear_pic), '">
            <input type="hidden" name="rear_pic_val" id="rear_pic_val" value="">
           </div>
        </div>';
        if (file_exists($frontfilename) && $mfg->Front_picture) {
            echo '<div class="col-sm-4 col-sm-offset-3"><img src="'.html_escape($frontweb_path).'" class="image-responsive" style="height:100px;width:180px;"><br/><h4> Front Picture</h4></div>';
        }
        if (file_exists($rearfilename) && $mfg->Rear_picture != "") {
            echo '<div class="col-sm-5"><img src="'.html_escape($rearweb_path).'" class="image-responsive" style="height:100px;width:180px;"><h4> Rear Picture</h4></div>';    
        }
    echo '</div>
</div> 
</div>
...
<div class="panel panel-default">
    ...
    <div class="panel-body">
        ...
        <div class="form-group">
            ...
            <div class="col-sm-9">      
             <select name="rack" id="rack" class="form-control" onchange="change_rack(this.value, ', html_escape($mfg->Position), ')">
                <option value="">', __("-- Select --"), '</option>';
    ...
    <div class="panel-body">
        ...
        echo '<option value="1" ' . $select1 . '>', __("1"), '</option>
            ...
            <div class="form-group">
                ...
                <div class="col-sm-9">      
                <input type="text" class="form-control" required name="community" id="community" value="', html_escape($mfg->Community), '">
                </div>    
            </div>
            <div class="clearfix"></div>
            <div class="form-group">
                ...
                <div class="col-sm-9">      
                <input type="text" class="form-control" required name="failures" id="failures" value="', html_escape($mfg->Failures), '">
                </div>    
            </div>
...
<div class="panel panel-default">
    ...
    <div class="panel-body">
        <div class="form-group">
           ...
           <div class="col-sm-9">      
           <input type="text" class="form-control" name="tag" id="tag" value="', html_escape($mfg->Tag), '">
           </div>    
        </div>
    </div>
</div>   
<div class="panel panel-default">
    ...
    <div class="panel-body">
        <div class="form-group">
           ...
           <div class="col-sm-9">      
           <textarea class="form-control" name="comment" id="comment">', html_escape($mfg->Comment), '</textarea>
           </div>    
        </div>
    </div>
</div>   
...
<script type="text/javascript">
    ...
    function change_rack(rack_id, selected) {
        ...
        $.ajax({
            ...
            type: 'post',
            data: {rack_id: rack_id, selected: selected, csrf_token: <?php echo js_escape(csrf_token()); ?>},
            dataType: 'JSON',
            success: function (res) {
                if (res.status == 'success') {
