...
class CabRow {
	...
	static function RowToObject($row){
		...
		$cabrow->ZoneID=$row["ZoneID"];
                $cabrow->Description=$row["description"];
	...
	function GetCabRowList(){
        ...
        function GetDashCabRowList(){
		$sql="SELECT c.*,z.description FROM fac_cabrow c LEFT JOIN fac_zone z ON(c.ZoneID=z.ZoneID) ORDER BY c.CabRowID DESC LIMIT 0,5;";
