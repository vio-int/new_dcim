...
<div class="form-group">
   ...
   <input type="hidden" name="action" value="query"><select id="deptid" name="deptid" class="form-control">
...
<div class="form-group">
   <label for="deptname">',__("Department Name"),'</label>
   <input type="text" class="form-control validate[required]" size="50" name="name" id="deptname" maxlength="80" value="',$dept->Name,'">
</div>
<div class="form-group">
   <label for="deptsponsor">',__("Executive Sponsor"),'</label>
   <input type="text" size="50" class="form-control" name="execsponsor" id="deptsponsor" maxlength="80" value="',$dept->ExecSponsor,'">
</div>
<div class="form-group">
   <label for="deptmgr">',__("Account Manager"),'</label>
   <input type="text" class="form-control" size="50" name="sdm" id="deptmgr" maxlength="80" value="',$dept->SDM,'">
</div>
<div class="form-group">
   <label for="deptcolor">',__("Department Color"),'</label>
   <input type="text" class="color-picker" size="50" name="deptcolor" id="deptcolor" maxlength="7" value="',$dept->DeptColor,'">
</div>
<div class="form-group">
   <label for="deptclass">',__("Classification"),'</label>
   <select name="classification" id="deptclass" class="form-control">';
...
<?php
	if($dept->DeptID > 0){
		echo '<button type="submit" name="action" class="btn btn-primary" value="Update">',__("Update"),'</button><button type="button" name="action" class="btn btn-primary" value="Delete">',__("Delete"),'</button><button type="button" class="btn btn-primary" onClick="showgroup(',$dept->DeptID,')">',__("Assign Contacts"),'</button>';
	}else{
