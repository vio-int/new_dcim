...
<div class="form-group">
   <label for="containerid">',__("Container"),'</label>
   <select name="containerid" id="containerid" class="form-control">
...
<div class="form-group">
   ...
   <input class="form-control validate[required,minSize[3],maxSize[80]]" type="text" name="name" id="cname" size="50" maxlength="80" value="',$c->Name,'">
</div>
<div class="form-group" style="display : none;">
   <label for="drawingfilename">',__("Drawing URL"),'</label>
   <input type="text" name="drawingfilename" class="form-control" id="drawingfilename" size=60 value="',$c->DrawingFileName,'">
</div>
<div><input type="hidden" name="cambio_cont" id="cambio_cont" value=""></div>
<div class="form-group" style="display : none;">
	<label for="parentid">',__("Parent Container"),'</label>
  	<select name="parentid" class="form-control" id="parentid" onChange="cambio_container()">
...
<div class="form-group">
	<b>Longitude</b>
 	<input type="number" step="any" class="form-control" name="x" id="x" onblur="mueve()" value="',$c->MapX,'" >
</div> 
<div class="form-group">
    <b>Latitude</b> 
    <input type="number" class="form-control" step="any" name="y" id="y" onblur="mueve()" value="',$c->MapY,'">
</div>'; 
...
echo '<div class="caption">';
	...
	if($c->ContainerID >0){
		print "\t<button type=\"submit\" class=\"btn btn-primary\" name=\"action\" value=\"Update\">".__("Update")."</button>\n";
		print "\t<button type=\"button\" class=\"btn btn-primary\" name=\"action\" value=\"Delete\">".__("Delete")."</button>\n";
	}else{
		print "\t<button type=\"submit\" class=\"btn btn-primary\" name=\"action\" value=\"Create\">".__("Create")."</button>\n";
	}
?>
</div>
</div> <!-- END div.table -->
