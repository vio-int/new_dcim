                        ...
                        <div class="main">
                            <div class="form_container">
                                ...
                                <form method="post">
                                    <div class="table">
                                        <?php
                                        print "<div>" . __("Please select the values to limit the report scope as indicated below.") . "</div></br>";

                                        print "<div class=\"form-group\"><div class=\"col-sm-2\"><label>" . __("Manufacturer") . "</label></div>";
                                        print "<div class=\"col-sm-4\"><select name=\"manufacturerid\" class=\"form-control\"><option value=0>All</option>";
                                        ...
                                        print "<div class=\"form-group\"><div class=\"col-sm-2\"><label>" . __("Device Type") . "</div>";
                                        print "<div class=\"col-sm-4\"><select name=\"devicetype\" class=\"form-control\"><option value=\"all\">All</option>";
                                        ...
                                        <div class="form-group">
                                            <div class="col-sm-6 text-center"><button type="submit" class="btn btn-primary" name="action" value="Submit">Submit</button></div>
                                        </div>
                                </form>
                                <?php
                            } else {
                                ...
                                for ($idx = 0; $idx < $max_remarks; $idx ++) {
                                    $row = $offset + $idx;
                                    $sheet->setCellValueExplicit('B' . ($row), $remarks[$idx], PHPExcel_Cell_DataType::TYPE_STRING);
                                }
