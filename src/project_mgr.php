...
<div class="form-group">
   ...
   <input type="hidden" name="action" value="query"><select id="projectid" class="form-control" name="projectid">
...
<div class="form-group">
   ...
   <input type="text" class="form-control validate[required]" size="50" name="projectname" id="projectname" maxlength="80" value="',$project->ProjectName,'">
</div>
<div class="form-group">
   <label for="projectsponsor">',__("Project Sponsor"),'</label>
   <input type="text" class="form-control" size="50" name="projectsponsor" id="projectsponsor" maxlength="80" value="',$project->ProjectSponsor,'">
</div>
<div class="form-group">
   <label for="projectstartdate">',__("Project Start Date"),'</label>
   <input type="text" class="form-control" size="50" name="projectstartdate" id="projectstartdate" maxlength="20" value="',$project->ProjectStartDate,'">
</div>
<div class="form-group">
   <label for="projectexpirationdate">',__("Project Expiration Date"),'</label>
   <input type="text" class="form-control" size="50" name="projectexpirationdate" id="projectexpirationdate" maxlength="20" value="',$project->ProjectExpirationDate,'">
</div>
<div class="form-group">
   <label for="projectactualenddate">',__("Project Actual End Date"),'</label>
   <input type="text" class="form-control" size="50" name="projectactualenddate" id="projectactualenddate" maxlength="20" value="',$project->ProjectActualEndDate,'">
</div>';
...
<?php
	if($project->ProjectID > 0){
		echo '<button type="submit" name="action" class="btn btn-primary" value="Update">',__("Update"),'</button><button type="button" name="action" class="btn btn-primary" value="Delete">',__("Delete"),'</button><button type="button" class="btn btn-primary" onClick="showdevs(',$project->ProjectID,')">',__("Assign Devices"),'</button><button type="button" class="btn btn-primary" onClick="showcabs(',$project->ProjectID,')">',__("Assign Cabinets"),'</button>';
	}else{
