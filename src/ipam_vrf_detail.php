...
$ipamVRF_arr = $ipamVRF->GetVRFOne($filter);
$ipamVRF_res = json_decode(json_encode($ipamVRF_arr), true);

$filter_2 = array();
$filter_2['sort_on'] = "Time";
$filter_2['sort_by'] = "DESC";
$filter_2['class'] = "IpamVRF";
$filter_2['object'] = $ipamVRF_res[0]['PortID'];
...
$filter_3['vrf'] = $ipamVRF_res[0]['PortID'];
                ...
                <div class="row">
                    <div class="col-sm-12 col-md-12">
                        <ol class="breadcrumb">
                            ...
                            <li><a href="ipam_vrf_list.php">VRF</a></li>
                            <li><?php echo $ipamVRF_res[0]['Name']; ?></li>
                        </ol>
                    </div>
                </div>
                <div class="pull-right">
                    <a href="ipam_vrf.php?PortID=<?php echo $ipamVRF_res[0]['PortID'] ?>" class="btn btn-warning">
                        <span class="fa fa-edit" aria-hidden="true"></span>
                        Edit this VRF
                    </a>
                    <a href="javascript:void(0);" class="btn btn-danger" id="delete" data-id="<?php echo $ipamVRF_res[0]['PortID'] ?>">
                        <span class="fa fa-trash" aria-hidden="true"></span>
                        Delete this VRF
                    </a>
                </div>
                <h1><?php echo $ipamVRF_res[0]['Name']; ?></h1>
                <p>
                    <small class="text-muted">Created <?php echo $ipamVRF_res[0]['Created_at']!="0000-00-00"?date("M. d, Y", strtotime($ipamVRF_res[0]['Created_at'])):"-"; ?> &middot; Updated <?php echo $ipamVRF_res[0]['Updated_at']!="0000-00-00"?date("M. d, Y", strtotime($ipamVRF_res[0]['Updated_at'])):"-"; ?></small>
                </p>
                <ul class="nav nav-tabs" style="margin-bottom: 20px">
                    <li class="tablinks active" onclick="openTab(event, 'VRF')" >
                        <a href="javascript:void(0);">VRF</a>
                    </li>
                        ...
                        <div class="col-md-6">
                            <div class="panel panel-default">
                                ...
                                <table class="table table-hover panel-body attr-table">
                                    <tr>
                                        <td>Name</td>
                                        <td><?php echo $ipamVRF_res[0]['Name']; ?></td>
                                    </tr>
                                    <tr>
                                        <td>Route Distinguisher</td>
                                        <td><?php echo $ipamVRF_res[0]['RD']; ?></td>
                                    </tr>
                                    <tr>
                                        <td>Unique IP Space</td>
                                        <td><?php echo $ipamVRF_res[0]['Enforce']=="Y"?'<i class="fa fa-check text-success"></i>':'<i class="fa fa-times text-danger"></i>'; ?></td>
                                    </tr>
                                    <tr>
                                        <td>Description</td>
                                        <td><span><?php echo $ipamVRF_res[0]['Description']; ?></span></td>
                                    </tr>
                                </table>
                            </div>
                            <div class="panel panel-default">
                                ...
                                <div class="panel-body">
                                    <span class="text-muted"><?php echo $ipamVRF_res[0]['Tag']; ?></span>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-6">
                                    ...
                                    <tfoot>
                                        <tr><td colspan="6" class="text-right">
                                            <?php 
                                                ...
                                                $pagLink = "<ul class='pagination'><li class='page-item page_go' data-id='1' data-obj='".$ipamVRF_res[0]['PortID']."'><a class='page-link' href='javascript:void(0);'>&laquo;</a></li>"; 
                                                for ($i=1; $i<=$total_pages; $i++) {
                                                    ...
                                                    $pagLink .= "<li class='page-item page_go' data-id='".$i."' data-obj='".$ipamVRF_res[0]['PortID']."'><a class='page-link ".$selected."' href='javascript:void(0);'>".$i."</a></li>";	
                                                }
                                                echo $pagLink . "<li class='page-item page_go' data-id='".$total_pages."' data-obj='".$ipamVRF_res[0]['PortID']."'><a class='page-link' href='javascript:void(0);'>&raquo;</a></li></ul>"; 
                                            ?>
                                        </td></tr>
                                    </tfoot>
                                    <?php } */ ?>    
    ...
    $(document).ready(function () {
        $('#delete').click(function () {
            if (confirm('Are you sure you want to delete this record ?')) {
                ...
                $.post('', {PortID: $(this).data("id"), TransferTo: transferto, action: 'Delete'}, function (data) {
                    if (data) {
                        location.href = 'ipam_vrf_list.php';
                    } else {
        ...
        $('.page_go').click(function () {
            ...
            $.ajax({
                ...
                data: {page:page_no, class: "IpamVRF", object:obj_id},
                dataType: 'JSON',
