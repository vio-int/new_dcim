...
<div class="form-group">
   <label for="ManufacturerID">',__("Manufacturer"),'</label>
   <input type="hidden" name="action" value="query"><select name="ManufacturerID" id="ManufacturerID" class="form-control">
...
<div class="form-group">
   <label for="gid">',__("Global ID"),'</label>
   <input type="text" id="gid" value="',$mfg->GlobalID,'" disabled class="form-control">
</div>
<div class="form-group">
...
<div class="form-group">
   <label for="SubscribeToUpdates">',__("Subscribe to Repository"),'</label>
   <input type="checkbox" name="SubscribeToUpdates" id="SubscribeToUpdates" ', $mfg->SubscribeToUpdates == 1 ? 'checked' : '', $mfg->GlobalID>0 ? '' : ' disabled','>
</div>
<div class="caption">';
