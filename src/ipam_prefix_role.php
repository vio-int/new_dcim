<?php
	...
	if(isset($_POST["action"])&&(($_POST["action"]=="Create")||($_POST["action"]=="Update"))){
            ...
            if($mfg->Name != null && $mfg->Name != ""){
                    if($_POST["action"]=="Create"){
                            if($mfg->CreateObject()){
                                    header('Location: '.redirect("ipam_prefix_role.php?PortID=$mfg->PortID"));
                            }else{
	...
	$mfgList=$mfg->GetIpamPrefixRoleList();
  ...
  <script type="text/javascript">
	$(document).ready(function() {
            ...
            $('#PortID').change(function(e){
                    location.href='ipam_prefix_role.php?PortID='+this.value;
            });
    ...
    <div class="row">
        <div class="col-sm-12 col-md-12">
            <ol class="breadcrumb">
                ...
                <li><a href="ipam_prefix_role_list.php">Prefix/ Role</a></li>
                <li><?php echo $mfg->PortID!=""?'Edit':'Add';?> Prefix/ Role</li>
            </ol>
        </div>
    </div>
    <!-- Breadcrumb code end -->
...
<div class="panel panel-default">
    ...
    <div class="form-group">
       ...
       <option value=0>',__("Role Name"),'</option>';
...
<div class="text-center">';
	if($mfg->PortID >0){
        ...
        echo '&nbsp;<a href="ipam_prefix_role_list.php" class="btn-panel btn-success">',__("Cancel"),'</a>';
?>
</div>
    </div>
</div>
