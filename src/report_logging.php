...
<html>
    ...
    <body>
        ...
        <div class="container wrapper">
            <div class="main1" style="margin-top:50px;margin-bottom:50px; ">
                <div class="row">
                    <div class="col-md-12">
                        <div class="table-responsive">
                            <?php
                            // include('sidebar.inc.php');
                            echo '<table class="table table-hover table-headings table-striped">
				<thead>
                                    <tr>
					<td>UserID</td>
					<td>Class</td>
				...
				<tbody>
                                    <tr>
					<td>', buildselect("UserID"), '</td>
					<td>', buildselect("Class"), '</td>
					<td>', buildselect("ObjectID"), '</td>
					<td>', buildselect("ChildID"), '</td>
					<td>', buildselect("Action"), '</td>
					<td>', buildselect("Property"), '</td>
					<td>', buildselect("OldVal"), '</td>
					<td>', buildselect("NewVal"), '</td>
					<td><select name="Limit"><option value=0>No Limit</option><option value=100>100</option><option value=1000 selected>1000</option><option value=5000>5000</option><option value=10000>10000</option></select></td>
                                    </tr>    
				</tbody>
			</table>
			<br><br>
			<div class="center">
                            <div id="tablecontainer">', $body, '</div>
			</div>';
                            ?>
                        </div>
                    </div><!-- END div.main -->
