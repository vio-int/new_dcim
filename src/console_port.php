	...
	if(isset($_POST["action"])&&(($_POST["action"]=="Create")||($_POST["action"]=="Update"))){
            ...
            if($mfg->Name != null && $mfg->Name != ""){
                    if($_POST["action"]=="Create"){
                            if($mfg->CreateObject()){
                                    header('Location: '.redirect("console_port.php?PortID=$mfg->PortID"));
                            }else{
        ...
        $type = "Console";
	$mfgList=$mfg->GetConsoleConnList($type);
  ...
  <script type="text/javascript">
	$(document).ready(function() {
            ...
            $('#PortID').change(function(e){
                    location.href='console_port.php?PortID='+this.value;
            });
...
<input type="hidden" name="port_type" value="Console">
<div class="panel panel-default">
    <div class="panel-heading"><strong>Console Port</strong></div>
    ...
    <div class="form-group">
       ...
       <option value=0>',__("Console Name"),'</option>';
