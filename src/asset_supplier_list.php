    ...
    <!-- LISTING CODE START -->
        <div class="container wrapper">
            ...
            <div class="row">
                ...
                <div class="col-sm-3">
                    <a href="asset_supplier.php" class="btn btn-primary">
                            ...
                            <table class="table table-hover table-headings table-striped">
                                <thead>
                                    <tr>
                                        ...
                                        <th class="orderable"><a href="?sort=dp.city&sort_by=<?= $sort_by ?>">City</a></th>
                                        <th class="orderable"><a href="?sort=a.state&sort_by=<?= $sort_by ?>">State</a></th>
                                        <th class="orderable"><a href="?sort=a.country&sort_by=<?= $sort_by ?>">Country</a></th>
                                        <th class="orderable"><a href="?sort=a.email&sort_by=<?= $sort_by ?>">Email</a></th>
                                        <th class="">Action</th>
                                    </tr>
                                </thead>
                                <tbody>
                                <?php if(count($assets_res) > 0){
                                    ...
                                    <tr>
                                        ...
                                        <td><a href="asset_supplier.php?PortID=<?php echo $res['PortID'] ?>"><i class="fa fa-edit"></i></a>
                                ...
                                <tfoot>
                                    <tr><td colspan="15" class="text-right">
                                        <?php 
                                            ...
                                            $total_rec = $assets->GetDashAssetSupplierList(); 
                                           
                                            $total_pages = ceil($total_rec['total_supplier'] / $limit); 
                ...
                <div class="col-md-3">
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <form action="asset_supplier_list.php" method="get" class="form">
                                <div class="form-group">
                                    <label for="id_assets">Supplier</label>
                                ...
                                <div class="text-right">
                                    ...
                                    <a href="asset_supplier_list.php" class="btn btn-default" style="line-height:1 !important">
