                    ...
                    <form id="mform" method="POST">
                            ...
                            <div class="panel panel-default floatdiv">
                                ...
                                <div class="panel-body">
                                    <?php if (count($Device_list) > 0) {
                                        foreach ($Device_list as $val) {
                                            $frontweb_path = _MEDIA_URL . "devices/{$val['Front_picture']}";
                                            $frontfilename = _PATH . '/uploads/devices' . DIRECTORY_SEPARATOR . $val['Front_picture'];
                                            ?>
                                        <div class="<?php echo $val['Height']>1?'multi_div':'device_div' ?>">
                                            <div draggable="true" ondragstart="drag(event)" id="device_<?= $val['PortID'] ?>" class="" data-height="<?php echo $val['Height'] ?>" data-power="<?php echo $val['Wattage'] ?>" data-device="<?php echo $val['Name'] ?>">
                                                <?php if (file_exists($frontfilename) && $val['Front_picture'] != "") { ?>
                                                <div class="col-sm-7"><img src="<?php echo $frontweb_path ?>" class="img-responsive device_image"></div>
                                                <?php } else { ?>
                        ...
                        <div class="col-sm-6">
                            <div class="panel panel-default">
                                <div class="panel-heading"><strong>Simulation</strong></div>
                                <div class="panel-body">
...
<?php } ?>
                                    ...
                                    <div class="form-group">
                                        <div class="col-sm-offset-3 col-sm-9 rack_str_div editable" id="rack_str" data-placeholder='Devices'>
...
<script type="text/javascript">
    $(document).ready(function () {
        ...
        $("#commit").click(function () {
            $.ajax({
                url: 'ajax_commit_simulation.php',
                type: 'post',
                data: $("form").serialize(),
                dataType: 'JSON',
                success: function (res) {
    ...
    $(document).on("click", '.sim_trash', function (event) {
        ...
        swalWithBootstrapButtons({
            ...
            if (result.value) {
                $.ajax({
                    url: 'ajax_delete_simulation.php',
                    type: 'post',
                    ...
                    success: function (res) {
                        if (res.status == 'success') {
                            ...
                            console.log(tmp_sim_height);
                            console.log(tmp_sim_power);
                            console.log(tmp_parent_id);
                            console.log(tmp_sim_position);
                            
                            console.log(tmp_site_act_height);
                            console.log(tmp_room_act_height);
                            console.log(tmp_rack_act_height);
                            console.log(tmp_site_act_power);
                            console.log(tmp_room_act_power);
                            console.log(tmp_rack_act_power);
