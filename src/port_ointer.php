	...
	if(isset($_POST["action"])&&(($_POST["action"]=="Create")||($_POST["action"]=="Update"))){
		...
		if($mfg->Name != null && $mfg->Name != ""){
			if($_POST["action"]=="Create"){
				if($mfg->CreateObject()){
					header('Location: '.redirect("port_ointer.php?PortID=$mfg->PortID"));
				}else{
  ...
  <script type="text/javascript">
	$(document).ready(function() {
		...
		$('#PortID').change(function(e){
			location.href='port_ointer.php?PortID='+this.value;
		});
...
<div class="form-group">
   ...
   <input type="text" class="form-control validate[required,minSize[1],maxSize[40]]" name="key" id="key" maxlength="40" value="',$mfg->Poi_key,'">
</div>
<div class="form-group">
