...
<div class="panel panel-default">
       ...
       <div class="col-sm-7">  
        <select name="status" id="status" class="form-control">
            ...
            foreach($status_list as $val){
                ...
                echo "<option value=\"$val->PortID\" $selected>$val->Status_name</option>\n";
            }
        echo '</select>
       </div>    
       <div class="col-sm-2">
    ...
    <div class="form-group">
        ...
        <input type="text" class="form-control" name="purchase_date" id="purchase_date" value="',$mfg->Purchase_date!="0000-00-00"?date('m/d/Y',strtotime($mfg->Purchase_date)):"",'">
    ...
    <div class="form-group">
        ...
        <div class="input-group col-sm-9" style="padding-left: 16px; padding-right: 14px;">
        <input type="text" class="form-control" name="first_main_date" id="first_main_date" value="',$mfg->First_main_date!="0000-00-00"?date('m/d/Y',strtotime($mfg->First_main_date)):"",'">
        <span class="input-group-addon"><i class="fa fa-calendar"></i></span>
        </div>    
    </div>
    ...
    <div class="form-group">
       ...
       <div class="input-group col-sm-9" style="padding-left: 16px; padding-right: 14px;">
       <input type="text" class="form-control" name="maintenance" id="maintenance" onchange="change_maintenance(this.value)" value="',$mfg->Maintenance,'">
    ...
    echo '<div class="form-group">
        ...
        <div class="input-group col-sm-9" style="padding-left: 16px; padding-right: 14px;">
        <input type="text" class="form-control" name="next_main_date" id="next_main_date" value="',$next_main_date,'" readonly>
        <span class="input-group-addon"><i class="fa fa-calendar"></i></span>
        </div>    
    </div>
    <div class="clearfix"></div>
    ...
    <div class="form-group">
       ...
       <div class="col-sm-9">      
       <input type="text" class="form-control" name="order_no" id="order_no" value="',$mfg->Order_no,'">
       </div>
    </div>
    <div class="form-group">
       <label class="col-sm-3" for="purchase_cost">',__("Purchase Cost"),'</label>
       <div class="input-group col-sm-9" style="padding-left: 16px; padding-right: 14px;">      
       <input type="text" class="form-control" name="purchase_cost" id="purchase_cost" value="',$mfg->Purchase_cost,'">
        <span class="input-group-addon">
            USD
        </span>
       </div>
    ...
    <div class="form-group">
       ...
       <div class="input-group col-sm-9" style="padding-left: 16px; padding-right: 14px;">
       <input type="text" class="form-control" name="warranty" id="warranty" value="',$mfg->Warranty,'">
        <span class="input-group-addon">
            Months
        </span>
       </div>
    ...
    <div class="form-group">
       ...
       <div class="col-sm-9">
       <textarea name="notes" class="form-control">',$mfg->Notes,'</textarea>
       </div>
    </div>
    <div class="form-group">
    ...
    <div class="form-group">
        ...
        <div class="col-sm-1">    
        <input type="checkbox" class="" name="requestable" id="requestable" value="',$mfg->Requestable==""?"N":$mfg->Requestable,'" ',$mfg->Requestable=="Y"?"checked":"",'>
        </div>
    </div>
    <div class="clearfix"></div>';
    
    $assetweb_path = _MEDIA_URL . "assets/{$mfg->Asset_image}";
    $assetfilename = _PATH . '/uploads/assets' . DIRECTORY_SEPARATOR . $mfg->Asset_image;

    $front_icon = "";
    $rear_icon = "";
    if (file_exists($assetfilename) && $mfg->Asset_image != "") {
        $rear_icon = "<a href='" . $assetweb_path . "' target='__blank'>" . $mfg->Asset_image . " <i class='fa fa-eye'></i></a>";
    }
    echo '<div class="form-group">
       <label class="col-sm-3" for="asset_image">', __("Upload Image"), '</label>
       <div class="col-sm-9">
       <input type="file" class="form-control" name="asset_image" id="asset_image" value="', $mfg->Asset_image, '">
       <output id="filesInfo"></output>
       <input type="hidden" name="asset_img" id="asset_img" value="', $mfg->Asset_img, '">  
       <input type="hidden" name="asset_img_val" id="asset_img_val" value="">  
       </div>
    </div>';
    if (file_exists($assetfilename) && $mfg->Asset_image) {
        echo '<div class="col-sm-4 col-sm-offset-3"><img src="'.$assetweb_path.'" class="image-responsive" style="height:100px;width:180px;"><br/><h4> Assets Picture</h4></div>';
    }
