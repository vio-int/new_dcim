...
$cluster_arr = $cluster->GetClusterOne($filter);
$cluster_res = json_decode(json_encode($cluster_arr), true);

$filter_2 = array();
$filter_2['sort_on'] = "Time";
$filter_2['sort_by'] = "DESC";
$filter_2['class'] = "Cluster";
$filter_2['object'] = $cluster_res[0]['PortID'];
...
$filter_3['vlan'] = $cluster_res[0]['PortID'];
$ipamPrefix_arr = $ipamPrefix->GetIpamPrefixListRows($filter_3);
//$device_res = json_decode(json_encode($ipamPrefix_arr), true);
                ...
                <div class="row">
                    <div class="col-sm-12 col-md-12">
                        <ol class="breadcrumb">
                            ...
                            <li><?php echo $cluster_res[0]['Name']; ?></li>
                        </ol>
                    </div>
                </div>
                <div class="pull-right">
                    <a href="cluster.php?PortID=<?php echo $cluster_res[0]['PortID'] ?>" class="btn btn-warning">
                        <span class="fa fa-edit" aria-hidden="true"></span>
                        Edit this cluster
                    </a>
                    <a href="javascript:void(0);" class="btn btn-danger" id="delete" data-id="<?php echo $cluster_res[0]['PortID'] ?>">
                        <span class="fa fa-trash" aria-hidden="true"></span>
                        Delete this cluster
                    </a>
                </div>
                <h1><?php echo $cluster_res[0]['Name']; ?></h1>
                <p>
                    <small class="text-muted">Created <?php echo $cluster_res[0]['Created_at']!="0000-00-00"?date("M. d, Y", strtotime($cluster_res[0]['Created_at'])):"-"; ?> &middot; Updated <?php echo $cluster_res[0]['Updated_at']!="0000-00-00"?date("M. d, Y", strtotime($cluster_res[0]['Updated_at'])):"-"; ?></small>
                </p>
                <ul class="nav nav-tabs" style="margin-bottom: 20px">
                    <li class="tablinks active" onclick="openTab(event, 'cluster')" >
                        ...
                        <div class="col-md-6">
                            <div class="panel panel-default">
                                ...
                                <table class="table table-hover panel-body attr-table">
                                    ...
                                    <tr>
                                        <td>Group</td>
                                        <td><?php echo $cluster_res[0]['Group_name']; ?></td>
                                    </tr>
                                    <tr>
                                        <td>Location</td>
                                        <td><?php echo $cluster_res[0]['Location_name']; ?></td>
                                    </tr>
                                    <tr>
                                        <td>Virtual Machine</td>
                                        <td><a href="vistual_machine_list.php?PortID=<?php echo $cluster_res[0]['Role']; ?>"><?php echo $cluster_res[0]['Total_machine']; ?></a></td>
                                    </tr>
                                </table>
                            </div>
                            <div class="panel panel-default">
                                ...
                                <div class="panel-body">
                                    <span class="text-muted"><?php echo $cluster_res[0]['Tag']; ?></span>
                                </div>
                            </div>
                            <div class="panel panel-default">
                                <div class="panel-heading">
                                ...
                                <div class="panel-body">
                                    <span class="text-muted"><?php echo $cluster_res[0]['Comment']; ?></span>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="panel panel-default">
                                ...
                                <div class="panel-body">
                                    ...
                                    <div class="pull-right"><a href="device.php" class="btn btn-primary"><i class="fa fa-plus"></i> Add devices</a></div>
                                    </div>
                                </div>
                            </div>
                        </div>
                                    ...
                                    <tfoot>
                                        <tr><td colspan="6" class="text-right">
                                            <?php 
                                                ...
                                                $pagLink = "<ul class='pagination'><li class='page-item page_go' data-id='1' data-obj='".$cluster_res[0]['PortID']."'><a class='page-link' href='javascript:void(0);'>&laquo;</a></li>"; 
                                                for ($i=1; $i<=$total_pages; $i++) {
                                                    ...
                                                    $pagLink .= "<li class='page-item page_go' data-id='".$i."' data-obj='".$cluster_res[0]['PortID']."'><a class='page-link ".$selected."' href='javascript:void(0);'>".$i."</a></li>";	
                                                }
                                                echo $pagLink . "<li class='page-item page_go' data-id='".$total_pages."' data-obj='".$cluster_res[0]['PortID']."'><a class='page-link' href='javascript:void(0);'>&raquo;</a></li></ul>"; 
                                            ?>
                                        </td></tr>
                                    </tfoot>
                                    <?php } */ ?>    
    ...
    $(document).ready(function () {
        ...
        $('.page_go').click(function () {
            ...
            $.ajax({
                ...
                data: {page:page_no, class: "Cluster", object:obj_id},
                dataType: 'JSON',
