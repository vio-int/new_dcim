...
$IpamVLAN_arr = $IpamVLAN->GetIpamVLANListRows($filter);
$IpamVLAN_res = json_decode(json_encode($IpamVLAN_arr), true);

$IpamVLAN_list_arr = $IpamVLAN->GetIpamVLANList();
$IpamVLAN_list_res = json_decode(json_encode($IpamVLAN_list_arr), true);
...
if(isset($_GET['export'])){
    $response = $IpamVLAN->ExportReport($filter);
    exit;
}
// Export Code End
?>
    ...
    <!-- LISTING CODE START -->
        <div class="container wrapper">
            ...
            <div class="row">
                ...
                <div class="col-sm-3">
                    <a href="ipam_vlan.php" class="btn btn-primary">
                            ...
                            <table class="table table-hover table-headings table-striped">
                                <thead>
                                    <tr>
                                        ...
                                        <th class="orderable"><a href="?sort=v.status&sort_by=<?= $sort_by ?>">Status</a></th>
                                ...
                                <tbody>
                                    <?php if(count($IpamVLAN_res) > 0){
                                        foreach($IpamVLAN_res as $res) { ?>
                                    <tr>
                                        <td><?php echo '<a href="ipam_vlan_detail.php?id='.$res['PortID'].'">'.$res['Name'].'</a>'; ?></td>
                                        <td><?php echo $res['Status'] ?></td>
                                        <td><?php echo $res['Location_name'] ?></td>
                                        <td><?php echo $res['Group_name']; ?></td>
                                        <td><?php echo $res['Role_name']; ?></td>
                                        <td><?php echo $res['Description'] ?></td>
                                        <td><a href="ipam_vlan.php?PortID=<?php echo $res['PortID'] ?>"><i class="fa fa-edit"></i></a>
                                ...
                                <tfoot>
                                    <tr><td colspan="7" class="text-right">
                                        <?php 
                                            ...
                                            $total_rec = $IpamVLAN->GetDashIpamVLANList(); 
                                            $total_pages = ceil($total_rec['total_vlan'] / $limit); 
                        ...
                        <div class="panel-body">
                            <form action="ipam_vlan_list.php" method="get" class="form">
                                ...
                                <div class="text-right">
                                    ...
                                    <a href="ipam_vlan_list.php" class="btn btn-default" style="line-height:1 !important">
