...
<div class="form-group">
   <label for="binid">',__("Bin Location"),'</label>
   <input type="hidden" name="action" value="query"><select name="binid" class="form-control" id="binid" onChange="form.submit()">
...
<div class="form-group">
   ...
   <input type="text" name="location" class="form-control" id="location" value="',$bin->Location,'">
</div>';
