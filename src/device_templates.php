...
<!-- Left side of device template -->
	...
	<div class="form-group">
		<label class="col-sm-3" for="TemplateID">', __("Template"), '</label>
		<div class="col-sm-9"><input type="hidden"><select class="from-control" name="TemplateID" id="TemplateID">
...
<div class="form-group">
	<label class="col-sm-3" for="ManufacturerID">', __("Manufacturer"), '</label>
	<div class="col-sm-9"><select name="ManufacturerID" class="form-control" id="ManufacturerID">';

foreach ($ManufacturerList as $ManufacturerRow) {
    if ($template->ManufacturerID == $ManufacturerRow->ManufacturerID) {
        $selected = " selected";
    } else {
        $selected = "";
    }
...
<div class="form-group">
   ...
   <div class="col-sm-9"><input type="text" name="Model" id="Model" class="form-control validate[required]" value="', $template->Model, '"></div>
</div>
<div class="form-group">
   <label class="col-sm-3" for="Height">', __("Height"), '</label>
   <div class="col-sm-9"><input type="text" class="form-control" name="Height" id="Height" value="', $template->Height, '">&nbsp;&nbsp;<span class="cdudisclaimer sensordisclaimer hide">', __("0 for a vertical mounting"), '</span></div>
</div>
<div class="form-group">
   <label class="col-sm-3" for="Weight">', __("Weight"), '</label>
   <div class="col-sm-9"><input class="form-control" type="text" name="Weight" id="Weight" value="', $template->Weight, '"></div>
</div>
<div class="form-group">
   <label class="col-sm-3" for="Wattage">', __("Wattage"), '</label>
   <div class="col-sm-9"><input class="form-control" type="text" name="Wattage" id="Wattage" value="', $template->Wattage, '"></div>
</div>
<div class="form-group">
   <label class="col-sm-3" for="DeviceType">', __("Device Type"), '</label>
   <div class="col-sm-9"><select class="form-control" name="DeviceType" id="DeviceType">';
...
<div class="form-group">
   <label class="col-sm-3" for="PSCount">', __("No. Power Connections"), '</label>
   <div class="col-sm-9"><input type="text" class="form-control" name="PSCount" id="PSCount" value="', $template->PSCount, '"><button type="button">', __("Edit Ports"), '</button></div>
</div>
<div class="clearfix"></div>
<div class="form-group">
   <label class="col-sm-3" for="NumPorts">', __("No. Ports"), '</label>
   <div class="col-sm-9"><input type="text" class="form-control" name="NumPorts" id="NumPorts" value="', $template->NumPorts, '"><button type="button">', __("Edit Ports"), '</button></div>
</div>
<div class="clearfix"></div>
<div class="form-group">
	<label class="col-sm-3" for="SNMPVersion">', __("SNMP Version"), '</label>
	<div class="col-sm-9"><select class="form-control" name="SNMPVersion" id="SNMPVersion">';
...
<div class="clearfix"></div>
<div class="form-group">
   <label class="col-sm-3" for="FrontPictureFile">', __("Front Picture File"), '</label>
   <div class="col-sm-9"><input type="text" class="form-control" name="FrontPictureFile" id="FrontPictureFile" value="', $template->FrontPictureFile, '"></div>
</div>
<div class="clearfix"></div>
<div class="form-group">
   <label class="col-sm-3" for="RearPictureFile">', __("Rear Picture File"), '</label>
   <div class="col-sm-9"><input type="text" class="form-control" name="RearPictureFile" id="RearPictureFile" value="', $template->RearPictureFile, '"></div>
</div>
<div class="clearfix"></div>
<div class="form-group" id="DivChassisSlots" style="display: ', (($template->DeviceType == "Chassis") ? 'table-row' : 'none'), ';">
   <label class="col-sm-3" for="ChassisSlots">', __("Chassis Slots"), '</label>
   <div class="col-sm-9"><input class="form-control" type="text" name="ChassisSlots" id="ChassisSlots" value="', $template->ChassisSlots, '"><button type="button">', __("Edit Coordinates"), '</button></div>
</div>
<div class="clearfix"></div>
<div id="DivRearChassisSlots" class="form-group" style="display: ',(($template->DeviceType == "Chassis") ? 'table-row' : 'none'), ';">
   <label class="col-sm-3" for="RearChassisSlots">', __("Rear Chassis Slots"), '</label>
   <div class="col-sm-9"><input type="text" class="form-control" name="RearChassisSlots" id="RearChassisSlots" value="', $template->RearChassisSlots, '"><button type="button">', __("Edit Coordinates"), '</button></div>
</div>';
...
<div class="form-group">
   ...
   <div class="col-sm-9"><textarea name="Notes" id="Notes" cols="40" rows="8">', $template->Notes, '</textarea></div>
</div>
<div class="clearfix"></div>
<div class="text-center form-button">';
if ($template->TemplateID > 0) {
    echo '<button type="submit" name="action" class="btn btn-lg btn-primary" value="Update">', __("Update Template"), '</button><button type="button" class="btn btn-lg btn-primary" id="clone">', __("Clone Template"), '</button><button id="delete" class="btn btn-lg btn-primary" type="button">', __("Delete Template"), '</button><button type="submit" class="btn btn-lg btn-primary" name="action" value="Device" id="device">', __("Update Devices"), '</button><button class="btn btn-lg btn-primary" type="submit" name="action" value="Export">', __("Export"), '</button>';
} else {
    echo '<button type="submit" name="action" class="btn btn-primary btn-lg" value="Create">', __("Create"), '</button>';
}
echo '<button type="button" name="importButton" class="btn btn-primary btn-lg" id="importButton" value="Import">', __("Import"), '</button>
