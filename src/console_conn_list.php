...
$ConsoleConn_arr = $ConsoleConn->GetConsoleConnListRows($filter);
$ConsoleConn_res = json_decode(json_encode($ConsoleConn_arr), true);

$Device_list_arr = $Device->GetDevice_newList();
$Device_list_res = json_decode(json_encode($Device_list_arr), true);

/* echo "<pre>";
print_r($ConsoleConn_res);
echo "<pre/>";exit; */
// Delete Code Start
if(isset($_POST['action']) && $_POST["action"]=="Delete"){
    ...
    if(isset($_POST["TransferTo"])){
        $ConsoleConn->PortID=$_POST['PortID'];
        if($ConsoleConn->DeleteObject($_POST["TransferTo"])){
            $response=true;
        }
    }
...
if(isset($_GET['export'])){
    $response = $ConsoleConn->ExportReport($filter);
    exit;
}
// Export Code End
?>
            ...
            <div class="row">
                ...
                <div class="col-sm-9">
                    <ol class="breadcrumb">
                        ...
                        <li>Console Connection</li>
                    </ol>
                    <h1>Console Connection</h1>
                </div>
                <div class="col-sm-3">
                    <a href="console_conn.php" class="btn btn-primary">
                            ...
                            <table class="table table-hover table-headings table-striped">
                                <thead>
                                    <tr>
                                        ...
                                        <th class="orderable"><a href="?sort=v.console_server&sort_by=<?= $sort_by ?>">Console Server</a></th>
                                        <th class="orderable"><a href="?sort=v.port&sort_by=<?= $sort_by ?>">Port</a></th>
                                        <th class="orderable"><a href="?sort=d.name&sort_by=<?= $sort_by ?>">Device</a></th>
                                        <th class="orderable"><a href="?sort=v.console_port&sort_by=<?= $sort_by ?>">Console Port</a></th>
                                        <th class="primary_ip">Action</th>
                                    </tr>
                                </thead>
                                <tbody>
                                    <?php if(count($ConsoleConn_res) > 0){
                                        foreach($ConsoleConn_res as $res) { ?>
                                    <tr>
                                        <td><?php echo $res['Console_server_name'] ?></td>
                                        <td><?php echo $res['Port'] ?></td>
                                        <td><?php echo $res['Device_name'] ?></td>
                                        <td><?php echo $res['Console_port'] ?></td>
                                        <td>
                                            <a href="console_conn.php?PortID=<?php echo $res['PortID'] ?>"><i class="fa fa-edit"></i></a>
                                ...
                                <tfoot>
                                    <tr><td colspan="5" class="text-right">
                                        <?php 
                                            ...
                                            $total_rec = $ConsoleConn->GetDashConsoleList(); 
                                            $total_pages = ceil($total_rec['total_console'] / $limit); 
                ...
                <div class="col-md-3">
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <form action="console_conn_list.php" method="get" class="form">
                                ...
                                <div class="text-right">
                                    ...
                                    <a href="console_conn_list.php" class="btn btn-default" style="line-height:1 !important">
