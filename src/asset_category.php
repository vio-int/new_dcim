	...
	if(isset($_POST["action"])&&(($_POST["action"]=="Create")||($_POST["action"]=="Update"))){
            ...
            if($mfg->Name != null && $mfg->Name != ""){
                    if($_POST["action"]=="Create"){
                            if($mfg->CreateObject()){
                                    header('Location: '.redirect("asset_category.php?PortID=$mfg->PortID"));
                            }else{
  ...
  <script type="text/javascript">
	$(document).ready(function() {
            ...
            $('#PortID').change(function(e){
                    location.href='asset_category.php?PortID='+this.value;
            });
    ...
    <div class="row">
        <div class="col-sm-12 col-md-12">
            <ol class="breadcrumb">
                ...
                <li><a href="asset_category_list.php">Category</a></li>
                <li><?php echo $mfg->PortID!=""?'Edit':'Add';?> Category</li>
            </ol>
        </div>
    </div>
    <!-- Breadcrumb code end -->
...
<div class="panel panel-default">
    ...
    <div class="form-group">
       ...
       <option value=0>',__("Category Name"),'</option>';
...
<div class="text-center">';
    ...
    echo '&nbsp;<a href="asset_category_list.php" class="btn-panel btn-success">',__("Cancel"),'</a>';
?>
</div>
    </div>
</div>
