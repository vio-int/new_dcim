...
select {padding: .05em;}
fieldset table, table {border: 1px solid #dddddd;}
...
.backgroundpage{
	background-size: cover;}
.page1 {position: relative;width: 100%; background-color:white; padding-bottom:15%; padding-top:2%}
.clear {clear: both;}
...
.meter-wrap, .meter-value, .meter-text {width: 210px; height: 1.5em;}
.meter-text {
	position: absolute;
	top:0; left:0;
	padding-top: 0px;
...
.dashboard-body .list-group-item h4 {
    text-align: left;
}
.row {
...
.dashboard-body .list-group-item p {
    font-size: 13px;
}
