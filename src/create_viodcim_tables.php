<?php
/**
 * Create VIODCIM Tables
 * Creates the missing tables required by VIODCIM (without fac_ prefix)
 */
...
try {
    ...
    // Room table
    $dbh->exec("CREATE TABLE IF NOT EXISTS room (
    ...
    $success[] = "Created room table";
    
    // Rack table
    $dbh->exec("CREATE TABLE IF NOT EXISTS rack (
        id INT(11) NOT NULL AUTO_INCREMENT,
        name VARCHAR(255) NOT NULL,
    ...
    $success[] = "Created rack table";
    
    // Device table
    $dbh->exec("CREATE TABLE IF NOT EXISTS device (
        id INT(11) NOT NULL AUTO_INCREMENT,
    ...
    $success[] = "Created device table";
    
    // Assets table
    $dbh->exec("CREATE TABLE IF NOT EXISTS assets (
        id INT(11) NOT NULL AUTO_INCREMENT,
        name VARCHAR(255) NOT NULL,
    ...
    $success[] = "Created assets table";
    
    // Manufacture table
    $dbh->exec("CREATE TABLE IF NOT EXISTS manufacture (
        id INT(11) NOT NULL AUTO_INCREMENT,
        name VARCHAR(255) NOT NULL,
        PRIMARY KEY (id)
    ) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4");
    $success[] = "Created manufacture table";
    
    // IPAM tables
    $dbh->exec("CREATE TABLE IF NOT EXISTS ipam_prefix (
        id INT(11) NOT NULL AUTO_INCREMENT,
    ...
    $success[] = "Created ipam_prefix table";
    
    $dbh->exec("CREATE TABLE IF NOT EXISTS ipam_vlan (
        id INT(11) NOT NULL AUTO_INCREMENT,
        vid INT(11) NOT NULL,
    ...
    $success[] = "Created ipam_vlan table";
    
    // Asset category table
    $dbh->exec("CREATE TABLE IF NOT EXISTS asset_category (
        id INT(11) NOT NULL AUTO_INCREMENT,
        name VARCHAR(255) NOT NULL,
        description TEXT,
        created DATE DEFAULT NULL,
    ...
    $success[] = "Created asset_category table";
    
    // Asset status table
    $dbh->exec("CREATE TABLE IF NOT EXISTS asset_status (
        id INT(11) NOT NULL AUTO_INCREMENT,
    ...
    $success[] = "Created asset_status table";
    
    // Commit transaction
    $dbh->commit();
    
    echo "<h1>✅ VIODCIM Tables Created Successfully!</h1>";
