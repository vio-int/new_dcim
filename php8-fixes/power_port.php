	...
	if(isset($_POST["action"])&&(($_POST["action"]=="Create")||($_POST["action"]=="Update"))){
            ...
            if($mfg->Name != null && $mfg->Name != ""){
                    if($_POST["action"]=="Create"){
                            if($mfg->CreateObject()){
                                    header('Location: '.redirect("power_port.php?PortID=$mfg->PortID"));
                            }else{
  ...
  <script type="text/javascript">
	$(document).ready(function() {
            ...
            $('#PortID').change(function(e){
                    location.href='power_port.php?PortID='+this.value;
            });
...
<input type="hidden" name="port_type" value="Power">
<div class="panel panel-default">
    <div class="panel-heading"><strong>Power Port</strong></div>
    ...
    <div class="form-group">
        ...
        <option value=0>',__("Port Name"),'</option>';
