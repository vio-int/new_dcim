...
<div class="form-group">
   <label for="supplyid">'.__("Part Number").'</label>
   <input type="hidden" name="action" class="form-control" value="query"><select name="supplyid" id="supplyid" onChange="form.submit()">
...
<div class="form-group">
   <label for="partnum">'.__("Part Number").'</label>
   <input type="text" name="partnum" class="form-control" id="partnum" value="'.$sup->PartNum.'">
</div>
<div class="form-group">
   <label for="partname">'.__("Part Name").'</label>
   <input type="text" name="partname" class="form-control" id="partname" value="'.$sup->PartName.'">
</div>
<div class="form-group">
   <label for="minqty">'.__("Min Qty").'</label>
   <input type="text" name="minqty" class="form-control" id="minqty" value='.$sup->MinQty.'>
</div>
<div class="form-group">
   <label for="maxqty">'.__("Max Qty").'</label>
   <input type="text" name="maxqty" id="maxqty" class="form-control" value='.$sup->MaxQty.'>
</div>
<div class="caption">
   <button type="submit" name="action" class="btn btn-primary" value="Create">Create</button>';
	if($sup->SupplyID >0){
		echo '   <button type="submit" class="btn btn-primary" name="action" value="Update">Update</button>';
	}
echo '
</div>
</div><!-- END div.table -->
