            ...
            <div class="page1 ">
                <div class="col-sm-12">
                    ...
                    echo '<div class="main1">
                        ...
                        <div class="col-sm-2"><label for="datacenterid">', __("Data Center:"), '</label></div>
			<div class="col-sm-4"><select name="datacenterid" id="datacenterid" class="form-control">
				...
				<option value="0">', __("All Data Centers"), '</option>';
                    ...
                    <div class="center">
                        <div class="table-responsive col-sm-12" id="tablecontainer">
<?php echo $body; ?>
                        </div>
                    </div>
                </div>
