...
<div class="caption">';
	...
	<button type="button" class="btn btn-primary" value="AuditReport">',__("Audit Report"),'</button>
	<button type="button" class="btn btn-primary" value="MapCoordinates">',__("Map Coordinates"),'</button>';
	}else{
