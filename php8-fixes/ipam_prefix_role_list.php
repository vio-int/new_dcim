...
$role_arr = $role->GetRoleListRows($filter);
$role_res = json_decode(json_encode($role_arr), true);
...
if(isset($_POST['action']) && $_POST["action"]=="Delete"){
    ...
    if(isset($_POST["TransferTo"])){
            $role->PortID=$_POST['PortID'];
            if($role->DeleteObject($_POST["TransferTo"])){
                    $response=true;
            }
    }
...
if(isset($_GET['export'])){
    $response = $role->ExportReport($filter);
    exit;
}
// Export Code End
?>
    ...
    <!-- LISTING CODE START -->
        <div class="container wrapper">
            ...
            <div class="row">
                ...
                <div class="col-sm-3">
                    <a href="ipam_prefix_role.php" class="btn btn-primary">
                            ...
                            <table class="table table-hover table-headings table-striped">
                                <thead>
                                    <tr>
                                        ...
                                        <th class="orderable"><a href="?sort=r.name&sort_by=<?= $sort_by ?>">Role Name</a></th>
                                        <th class="orderable">Prefixes</th>
                                        <th class="orderable">VLANs</th>
                                        <th class="orderable"><a href="?sort=r.slug&sort_by=<?= $sort_by ?>">Slug</a></th>
                                        <th class="primary_ip">Action</th>
                                    </tr>
                                </thead>
                                <tbody>
                                    <?php if(count($role_res) > 0){
                                        foreach($role_res as $res) { ?>
                                    <tr>
                                        <td><?php echo $res['Name'] ?></td>
                                        <td><?php echo $res['Total_prefix'] ?></td>
                                        <td><?php echo $res['Total_vlan'] ?></td>
                                        <td><?php echo $res['Slug'] ?></td>
                                        <td><a href="ipam_prefix_role.php?PortID=<?php echo $res['PortID'] ?>"><i class="fa fa-edit"></i></a>
                                ...
                                <tfoot>
                                    <tr><td colspan="5" class="text-right">
                                        <?php 
                                            ...
                                            $total_rec = $role->GetDashIpamRoleList(); 
                                            $total_pages = ceil($total_rec['total_role'] / $limit); 
                ...
                <div class="col-md-3">
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <form action="ipam_prefix_role_list.php" method="get" class="form">
                                <div class="form-group">
                                    <label for="">Role Name</label>
                                    <select name="role" placeholder="Role Name" size="6" multiple="multiple" id="id_role" class="form-control">
                                ...
                                <div class="text-right">
                                    ...
                                    <a href="ipam_prefix_role_list.php" class="btn btn-default" style="line-height:1 !important">
