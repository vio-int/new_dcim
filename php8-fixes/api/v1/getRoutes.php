...
$app->get('/location', function() {
	// Don't have to worry about rights, other than basic connection, to get location
	...
	$r['status'] = "Success";
	$r['statuscode'] = 200;
	$r['location'] = specifyAttributes( $outputAttr, $location->Search( false, $loose ));
        echoResponse( $r );
});
...
$app->get('/room', function() {
	// Don't have to worry about rights, other than basic connection, to get room
	...
	$r['status'] = "Success";
	$r['statuscode'] = 200;
	$r['room'] = specifyAttributes( $outputAttr, $room->Search( false, $loose ));
        echoResponse( $r );
});
...
$app->get('/rack', function() {
	// Don't have to worry about rights, other than basic connection, to get rack
	...
	$r['status'] = "Success";
	$r['statuscode'] = 200;
	$r['rack'] = specifyAttributes( $outputAttr, $rack->Search( false, $loose ));
        echoResponse( $r );
});
...
$app->get('/devices', function() {
	// Don't have to worry about rights, other than basic connection, to get devices
	...
	$r['status'] = "Success";
	$r['statuscode'] = 200;
	$r['device'] = specifyAttributes( $outputAttr, $device->Search( false, $loose ));
        echoResponse( $r );
});

//	URL:	/api/v1/assets_management/
//	Method:	GET
//	Params:	none
//	Returns:  All Assets Management

$app->get('/assets_management', function() {
	// Don't have to worry about rights, other than basic connection, to get assets management
	...
	$r['status'] = "Success";
	$r['statuscode'] = 200;
	$r['assets'] = specifyAttributes( $outputAttr, $assets->Search( false, $loose ));
        echoResponse( $r );
});

//	URL:	/api/v1/assets_status/
//	Method:	GET
//	Params:	none
//	Returns:  All Assets Status

$app->get('/assets_status', function() {
	// Don't have to worry about rights, other than basic connection, to get assets status
	...
	$r['status'] = "Success";
	$r['statuscode'] = 200;
	$r['assets_status'] = specifyAttributes( $outputAttr, $assets->SearchStatus( false, $loose ));
        echoResponse( $r );
});

//	URL:	/api/v1/assets_supplier/
//	Method:	GET
//	Params:	none
//	Returns:  All Assets Spplier

$app->get('/assets_supplier', function() {
	// Don't have to worry about rights, other than basic connection, to get assets supplier
	...
	$r['status'] = "Success";
	$r['statuscode'] = 200;
	$r['assets_supplier'] = specifyAttributes( $outputAttr, $assets->Search( false, $loose ));
        echoResponse( $r );
});

//	URL:	/api/v1/assets_model/
//	Method:	GET
//	Params:	none
//	Returns:  All Assets Model

$app->get('/assets_model', function() {
	// Don't have to worry about rights, other than basic connection, to get assets model
	...
	$r['status'] = "Success";
	$r['statuscode'] = 200;
	$r['assets_model'] = specifyAttributes( $outputAttr, $assets->Search( false, $loose ));
        echoResponse( $r );
});
...
$app->get('/assets_main_history', function() {
	// Don't have to worry about rights, other than basic connection, to get assets model
	...
	$r['status'] = "Success";
	$r['statuscode'] = 200;
	$r['assets_maintanance_history'] = specifyAttributes( $outputAttr, $assets->SearchHistory( false, $loose ));
        echoResponse( $r );
});
...
$app->get('/interface', function() {
	// Don't have to worry about rights, other than basic connection, to get interface
    
	$InterfaceConn = new InterfaceConn();
	...
	$r['status'] = "Success";
	$r['statuscode'] = 200;
	$r['interface_conn'] = specifyAttributes( $outputAttr, $InterfaceConn->Search( false, $loose ));
        echoResponse( $r );
});
...
//	Method:	GET
//	Params:	none
//	Returns:  All console connection
...
$app->get('/console', function() {
	...
	$r['status'] = 'success';
	$r['statuscode'] = 200;
	$r['console_conn'] = specifyAttributes( $outputAttr, $consoleConn->Search( false, $loose ));
        echoResponse( $r );
});
...
//	Method:	GET
//	Params:	none
//	Returns:  All power connection

$app->get('/power', function() {
	// Don't have to worry about rights, other than basic connection, to get power connection
	...
	$r['status'] = 'success';
	$r['statuscode'] = 200;
	$r['power_conn'] = specifyAttributes( $outputAttr, $powerConn->Search( false, $loose ));
        echoResponse( $r );
});
...
$app->get('/cluster', function() {
	// Don't have to worry about rights, other than basic connection, to get cluster
	...
	$r['status'] = 'success';
	$r['statuscode'] = 200;
	$r['cluster'] = specifyAttributes( $outputAttr, $cluster->Search( false, $loose ));
        echoResponse( $r );
});

//	URL:	/api/v1/cluster_type/
//	Method:	GET
//	Params:	none
//	Returns:  All cluster type

$app->get('/cluster_type', function() {
	// Don't have to worry about rights, other than basic connection, to get cluster type
	...
	$r['status'] = 'success';
	$r['statuscode'] = 200;
	$r['cluster_type'] = specifyAttributes( $outputAttr, $cluster_type->Search( false, $loose ));
        echoResponse( $r );
});

//	URL:	/api/v1/cluster_group/
//	Method:	GET
//	Params:	none
//	Returns:  All cluster group

$app->get('/cluster_group', function() {
	// Don't have to worry about rights, other than basic connection, to get cluster group
	...
	$r['status'] = 'success';
	$r['statuscode'] = 200;
	$r['cluster_group'] = specifyAttributes( $outputAttr, $cluster_group->Search( false, $loose ));
        echoResponse( $r );
});

//	URL:	/api/v1/virtual_machine/
//	Method:	GET
//	Params:	none
//	Returns:  All virtual machine

$app->get('/virtual_machine', function() {
	// Don't have to worry about rights, other than basic connection, to get virtual machine
	...
	$r['status'] = 'success';
	$r['statuscode'] = 200;
	$r['virtual_machine'] = specifyAttributes( $outputAttr, $virtual_machine->Search( false, $loose ));
        echoResponse( $r );
});
...
//	Method:	GET
//	Params:	none
//	Returns:  All aggregate

$app->get('/aggregate', function() {
	// Don't have to worry about rights, other than basic connection, to get aggregate
	...
	$r['status'] = 'success';
	$r['statuscode'] = 200;
	$r['ipam_aggregate'] = specifyAttributes( $outputAttr, $ipam_aggregate->Search( false, $loose ));
        echoResponse( $r );
});
...
$app->get('/prefix', function() {
	// Don't have to worry about rights, other than basic connection, to get prefix
	...
	$r['status'] = 'success';
	$r['statuscode'] = 200;
	$r['ipam_prefix'] = specifyAttributes( $outputAttr, $ipam_prefix->Search( false, $loose ));
        echoResponse( $r );
});

//	URL:	/api/v1/prefix_role/
//	Method:	GET
//	Params:	none
//	Returns:  All prefix role

$app->get('/prefix_role', function() {
	// Don't have to worry about rights, other than basic connection, to get prefix role
	...
	$r['status'] = 'success';
	$r['statuscode'] = 200;
	$r['ipam_prefix_role'] = specifyAttributes( $outputAttr, $ipam_prefix_role->Search( false, $loose ));
        echoResponse( $r );
});

//	URL:	/api/v1/ipaddress/
//	Method:	GET
//	Params:	none
//	Returns:  All ip address

$app->get('/ipaddress', function() {
	// Don't have to worry about rights, other than basic connection, to get ip address
	...
	$r['status'] = 'success';
	$r['statuscode'] = 200;
	$r['ipam_ipaddress'] = specifyAttributes( $outputAttr, $ipam_ipaddress->Search( false, $loose ));
        echoResponse( $r );
});
...
$app->get('/vlan', function() {
	// Don't have to worry about rights, other than basic connection, to get vlan
	...
	$r['status'] = 'success';
	$r['statuscode'] = 200;
	$r['ipam_vlan'] = specifyAttributes( $outputAttr, $ipam_vlan->Search( false, $loose ));
        echoResponse( $r );
});

//	URL:	/api/v1/vlan_group/
//	Method:	GET
//	Params:	none
//	Returns:  All vlan group

$app->get('/vlan_group', function() {
	// Don't have to worry about rights, other than basic connection, to get vlan group
	...
	$r['status'] = 'success';
	$r['statuscode'] = 200;
	$r['ipam_vlan_group'] = specifyAttributes( $outputAttr, $ipam_vlan_group->Search( false, $loose ));
        echoResponse( $r );
});
...
$app->get('/rir', function() {
	// Don't have to worry about rights, other than basic connection, to get rir
	...
	$r['status'] = 'success';
	$r['statuscode'] = 200;
	$r['ipam_rir'] = specifyAttributes( $outputAttr, $ipam_rir->Search( false, $loose ));
        echoResponse( $r );
});
...
$app->get('/vrf', function() {
	// Don't have to worry about rights, other than basic connection, to get vrf
	...
	$r['status'] = 'success';
	$r['statuscode'] = 200;
	$r['ipam_vrf'] = specifyAttributes( $outputAttr, $ipam_vrf->Search( false, $loose ));
        echoResponse( $r );
});
...
$app->get('/service', function() {
	// Don't have to worry about rights, other than basic connection, to get service
	...
	$r['status'] = 'success';
	$r['statuscode'] = 200;
	$r['service'] = specifyAttributes( $outputAttr, $service->Search( false, $loose ));
        echoResponse( $r );
});
...
$app->get('/idrac', function() {
	...
	$r['status'] = 'success';
	$r['statuscode'] = 200;
	$r['idrac_setting'] = specifyAttributes( $outputAttr, $idrac_setting->Search( false, $loose ));
        echoResponse( $r );
});
?>
