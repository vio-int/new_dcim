...
<html>
    ...
    <div class="form-group">
                        <div class="col-sm-2"><label for="containmenttype">', __("Filter type:"), '</label></div>
                        <div class="col-sm-4"><select name="containmenttype" id="containmenttype" class="form-control">
                ...
                if (!is_executable($dotCommand)) {
                    echo '<div class="clearfix"></div><span class="errmsg">ERROR: You must have the dot command (from the graphviz package) installed and its location specified in the configuration</span>';
                }
                ?>  </div>
        </div><!-- END div.main -->
    </div><!-- END div.page -->
