...
<div class="form-group">
   <label for="PanelID">',__("Power Panel ID"),'</label>
   <select name="PanelID" id="PanelID" class="form-control">
...
<div class="form-group">
   <label for="PanelLabel">',__("Panel Name"),'</label>
   <input type="text" size="40" name="PanelLabel" class="form-control" id="PanelLabel" value="',$panel->PanelLabel,'">
</div>
<div class="form-group">
   <label for="NumberOfPoles">',__("Number of Poles"),'</label>
   <input type="number" name="NumberOfPoles" class="form-control" id="NumberOfPoles" size="3" value="',$panel->NumberOfPoles,'">
</div>
<div class="form-group">
   <label for="MainBreakerSize">',__("Main Breaker Amperage"),'</label>
   <input type="number" name="MainBreakerSize" id="MainBreakerSize" class="form-control" size="4" value="',$panel->MainBreakerSize,'">
</div>
<div class="form-group">
   <label for="PanelVoltage">',__("Panel Voltage"),'</label>
   <input type="number" name="PanelVoltage" id="PanelVoltage" class="form-control" size="4" value="',$panel->PanelVoltage,'">
</div>
<div class="form-group">
   <label for="NumberScheme">',__("Numbering Scheme"),'</label>
   <select name="NumberScheme" id="NumberScheme" class="form-control">';
...
<div class="form-group">
	<label for="ParentPanelID"><?php print __("Parent Panel"); ?></label>
	<select name="ParentPanelID" id="ParentPanelID" class="form-control">
...
<div class="form-group">
	<label for="ParentBreakerName">',__("Parent Breaker Name"),'</label>
	<input type="text" name="ParentBreakerName" id="ParentBreakerName" size="40" class="form-control" value="',$panel->ParentBreakerName,'">
</div>
<div class="form-group">
	<label for="PanelIPAddress">',__("Panel Meter IP Address"),'</label>
	<input type="text" name="PanelIPAddress" class="form-control" id="PanelIPAddress" size="30" value="',$panel->PanelIPAddress,'">
</div>
<div class="form-group">
	<label for="TemplateID">',__("CDU/Meter Template"),'</label>
...
<div class="form-group">
	<label for="MapDataCenterID">',__("Data Center (for Mapping)"),'</label>
	
		<select name="MapDataCenterID" id="MapDataCenterID" class="form-control">
...
<div class="caption">';
	...
	<button type="submit" name="action" class="btn btn-primary" value="Map">',__("Map Coordinates"),'</button>';
	}else{
