...
<div class="form-group">
   <label for="dispositionid">',__("Disposition ID"),'</label>
   <select name="dispositionid" class="form-control" id="dispositionid" onChange="form.submit()">
...
<div class="form-group">
   ...
   <input class="form-control validate[required,minSize[3],maxSize[80]]" type="text" name="name" id="name" size="50" maxlength="80" value="',$disp->Name,'">
</div>
<div class="form-group">
   <label for="description">',__("Description"),'</label>
   <input type="text" name="description" id="description" class="form-control" size="50" maxlength="255" value="',$disp->Description,'">
</div>
<div class="form-group">
   <label for="referencenumber">',__("Reference Number (Contract)"),'</label></div>
   <input type="text" name="referencenumber" class="form-control" id="referencenumber" size="50" maxlength="80" value="',$disp->ReferenceNumber,'">
</div>
<div class="form-group">
