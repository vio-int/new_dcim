...
<div class="form-group">
   <label for="pathid">',__("Identifier"),'</label>
   <input type="text" name="pathid" id="pathid" size="20" class="form-control" value="',(isset($_POST['pathid'])?$_POST['pathid']:""),'">
</div>
<div class="caption"><button type="submit" class="btn btn-primary" name="action" value="PathIdSearch">',__("Search"),'</button></div>
</div> <!-- END div.table -->
</form></fieldset></td>
...
<div class="table">
	<div class="form-group">
		<label for="dc-rear">',__("Data Center"),'</label>
		<div class="form-control">'.builddclist('dc-rear').'</div>
	</div>
<br>
<div class="caption">';
echo '	 <button type="submit" name="action" class="btn btn-primary" value="DevicePortSearch">',__("Search"),'</button></div>';
