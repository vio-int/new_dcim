<?php
	...
	if(isset($_POST["action"])&&(($_POST["action"]=="Create")||($_POST["action"]=="Update"))){
            ...
            $mfg->RD=trim($_POST["rd"]);
            $mfg->Enforce=trim($_POST["enforce"]);
            ...
            if($mfg->Name != null && $mfg->Name != ""){
                    if($_POST["action"]=="Create"){
                            if($mfg->CreateObject()){
                                    header('Location: '.redirect("ipam_vrf.php?PortID=$mfg->PortID"));
                            }else{
  ...
  <script type="text/javascript">
	$(document).ready(function() {
            ...
            $('#PortID').change(function(e){
                    location.href='ipam_vrf.php?PortID='+this.value;
            });
    ...
    <div class="row">
        <div class="col-sm-12 col-md-12">
            <ol class="breadcrumb">
                ...
                <li><?php echo $mfg->PortID!=""?'Edit':'Add';?> VRF</li>
            </ol>
        </div>
    </div>
    <!-- Breadcrumb code end -->
...
<div class="panel panel-default">
    ...
    <div class="form-group">
       ...
       <option value=0>',__("VRF Name"),'</option>';
    ...
    <div class="form-group">
       <label class="col-sm-3" for="rd">',__("RD"),'</label>
       <div class="col-sm-9">        
       <input type="text" class="form-control validate[required,minSize[1],maxSize[40]]" name="rd" id="rd" maxlength="40" value="',$mfg->RD,'">
       <span>Route distinguisher in any format</span>    
       </div>
    </div>
    <div class="form-group">
        <div class="col-sm-9 col-sm-offset-3">    
        <input type="checkbox" class="" name="enforce" id="enforce" value="',$mfg->Enforce==""?"N":$mfg->Enforce,'" ',$mfg->Enforce=="Y"?"checked":"",'>
        <label for="Enforce unique space">',__("Enforce unique space"),'</label></br>
        <span>Prevent duplicate prefixes/IP addresses within this VRF</span>    
        </div>
    </div>
    <div class="form-group">
...
<div class="panel panel-default">
    ...
    <div class="panel-body">
        <div class="form-group">
           ...
           <div class="col-sm-9">    
           <input type="text" class="form-control" name="tag" id="tag" maxlength="40" value="',$mfg->Tag,'">
           </div>    
        </div>
    </div>
</div>    
<div class="text-center">';
	if($mfg->PortID >0){
        ...
        echo '&nbsp;<a href="ipam_vrf_list.php" class="btn-panel btn-success">',__("Cancel"),'</a>';
?>
</div>
    </div>
</div>
