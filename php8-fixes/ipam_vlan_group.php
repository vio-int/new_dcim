<?php
	...
	if(isset($_POST["action"])&&(($_POST["action"]=="Create")||($_POST["action"]=="Update"))){
            ...
            if($mfg->Name != null && $mfg->Name != ""){
                    if($_POST["action"]=="Create"){
                            if($mfg->CreateObject()){
                                    header('Location: '.redirect("ipam_vlan_group.php?PortID=$mfg->PortID"));
                            }else{
	...
	$mfgList=$mfg->GetIpamVLANGroupList();
  ...
  <script type="text/javascript">
	$(document).ready(function() {
            ...
            $('#PortID').change(function(e){
                    location.href='ipam_vlan_group.php?PortID='+this.value;
            });
    ...
    <div class="row">
        <div class="col-sm-12 col-md-12">
            <ol class="breadcrumb">
                ...
                <li><?php echo $mfg->PortID!=""?'Edit':'Add';?> VLAN Group</li>
            </ol>
        </div>
    </div>
    <!-- Breadcrumb code end -->
...
<div class="panel panel-default">
    ...
    <div class="form-group">
       ...
       <option value=0>',__("VLAN Group Name"),'</option>';
...
<div class="text-center">';
	if($mfg->PortID >0){
        ...
        echo '&nbsp;<a href="ipam_vlan_group_list.php" class="btn-panel btn-success">',__("Cancel"),'</a>';
?>
</div>
    </div>
</div>
