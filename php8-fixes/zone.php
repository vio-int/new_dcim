...
echo '</select></div>
						...
						<input type="text" size="50" name="description" class="form-control" id="description" value="',$zone->Description,'"></div>
					</div>
					<div class="form-group">
						<label for="x1">X1</label>
						<input type="text" class="form-control" name="x1" id="x1" value="',$zone->MapX1,'">
					</div>
					<div class="form-group">
						<label for="y1">Y1</label>
						<input type="text" class="form-control" name="y1" id="y1" value="',$zone->MapY1,'">
					</div>
					<div class="form-group">
						<label for="x2">X2</label>
						<input type="text" class="form-control" name="x2" id="x2" value="',$zone->MapX2,'">
					</div>
					<div class="form-group">
						<label for="y2">Y2</label>
                                                <input type="text" class="form-control" name="y2" id="y2" value="',$zone->MapY2,'">					</div>
					<div class="form-group">
						<label for="zoom">',__("Zoom"),' (%)</label>
						<input type="text" class="form-control" name="mapzoom" id="mapzoom" value="',$zone->MapZoom,'">
					</div>';

	if($zone->ZoneID==0){
		echo '
					<div class="caption"><button type="submit" class="btn btn-primary" name="action" value="Create">',__("Create"),'</button></div>';
	}
	else{
		echo '
					<div><div>&nbsp;</div><div></div></div>
					<div class="caption"><button type="submit" class="btn btn-primary" name="action" value="Update">',__("Update"),'</button>
					<button type="button" class="btn btn-primary" name="action" value="Delete">',__("Delete"),'</button></div>';
	}
