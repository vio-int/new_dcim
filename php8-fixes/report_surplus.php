...
<div class="table">
	<div class="from-group">
		<label for="dispositionid">',__("Disposal Mechanism"),':</label>
		<select name="dispositionid" class="form-control" id="dispositionid"><option value="0">All Mechanisms</option>';
	...
	<div class="caption">
		<button type="submit" class="btn btn-primary" value="Generate" name="action">Generate</button>
	</div>
</div>
</form>
