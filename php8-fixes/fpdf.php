...
function _dochecks()
{
	...
	// Ensure runtime magic quotes are disabled (deprecated in PHP 7.0, removed in PHP 8.0)
	// These functions no longer exist in PHP 8.x, magic quotes were removed in PHP 5.4
