...
<div class="form-group">
   <label for="escalationtimeid">',__("Escalation Time Period"),'</label>
   <input type="hidden" name="action" value="query"><select name="escalationtimeid" class="form-control" id="escalationtimeid" onChange="form.submit()">
...
<div class="form-group">
   <label for="timeperiod">',__("Description"),'</label>
   <textarea name="timeperiod" class="form-control" id="timeperiod">',$period->TimePeriod,'</textarea>
</div>
<div class="caption">';
