...
$assets_arr = $assets->GetAssetListRow($filter);
...
$status_list = $assets->GetStatusList();
                            ...
                            <table class="table table-hover table-headings table-striped">
                                <thead>
                                    <tr>
                                        ...
                                        <th class="orderable"><a href="?sort=a.status&sort_by=<?= $sort_by ?>">Location</a></th>
                                        <th class="orderable"><a href="?sort=a.status&sort_by=<?= $sort_by ?>">Room</a></th>
                                        <th class="orderable"><a href="?sort=a.status&sort_by=<?= $sort_by ?>">Rack</a></th>
                                        <th class="orderable"><a href="?sort=a.asset_tag&sort_by=<?= $sort_by ?>">Asset Tag</a></th>
                                        <th class="orderable"><a href="?sort=dp.name&sort_by=<?= $sort_by ?>">Model</a></th>
                                        <th class="orderable"><a href="?sort=a.primary_ip&sort_by=<?= $sort_by ?>">Supplier</a></th>
                                        <th class="orderable"><a href="?sort=a.manufacture_date&sort_by=<?= $sort_by ?>">Status</a></th>
                                        <th class="orderable"><a href="?sort=a.purchase_cost&sort_by=<?= $sort_by ?>">Purchase Cost</a></th>
                                        <th class="orderable"><a href="?sort=a.install_date&sort_by=<?= $sort_by ?>">Purchase Date</a></th>
                                        <th class="">Action</th>
                                    </tr>
                                </thead>
                                <tbody>
                                <?php if(count($assets_res) > 0){
                                    ...
                                    <tr>
                                        ...
                                        <td><?php echo $res['Asset_tag'] ?></td>
                                        <td><?php echo $res['Model_name'] ?></td>
                                        <td><?php echo $res['Supplier_name'] ?></td>
                                        <td><?php echo $res['Status_name'] ?></td>
                                        <td><?php echo "$".$res['Purchase_cost'] ?></td>
                                        <td><?php echo $res['Purchase_date']!="0000-00-00"?date("m/d/Y",strtotime($res['Purchase_date'])):"-" ?></td>
                                        <td><a href="asset.php?PortID=<?php echo $res['PortID'] ?>"><i class="fa fa-edit"></i></a>
                                ...
                                <tfoot>
                                    <tr><td colspan="15" class="text-right">
                                        <?php 
                                            ...
                                            $total_rec = $assets->GetDashAssetList(); 
                ...
                <div class="col-md-3">
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <form action="asset_list.php" method="get" class="form">
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="status" placeholder="None" id="id_status" class="form-control">
                                        <option value="">-- Select --</option>
                                        <?php foreach($status_list_res as $val) { ?>
                                        <option value="<?php echo $val['PortID'] ?>" <?php echo $val['PortID']==$_GET['status']?'selected':''?>><?php echo $val['Status_name'] ?></option>
                                        <?php } ?>
                                ...
                                <div class="text-right">
                                    ...
                                    <a href="asset_list.php" class="btn btn-default" style="line-height:1 !important">
