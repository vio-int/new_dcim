...
<div class="form-group">
   <label for="PersonID">',__("User"),'</label>
...
echo '	</select>&nbsp;&nbsp;<span title="',__("This user is the primary contact for this many devices"),'" id="PrimaryContact"></span>
</div>
<div class="form-group">
   <label for="UserID">',__("UserID"),'</label>
   <input type="text" class="form-control validate[required,minSize[1],maxSize[50]]" name="UserID" id="UserID" value="',$userRights->UserID,'">
</div>
<div class="form-group">
   <label for="LastName">',__("Last Name"),'</label>
   <input type="text" class="form-control validate[required,minSize[1],maxSize[50]]" name="LastName" id="LastName" value="',$userRights->LastName,'">
</div>
<div class="form-group">
   <label for="FirstName">',__("First Name"),'</label>
   <input type="text" class="form-control validate[required,minSize[1],maxSize[50]]" name="FirstName" id="FirstName" value="',$userRights->FirstName,'">
</div>
<div class="form-group">
   <label for="Phone1">',__("Phone 1"),'</label>
   <input type="text" class="form-control" name="Phone1" id="Phone1" value="',$userRights->Phone1,'">
</div>
<div class="form-group">
   <label for="Phone2">',__("Phone 2"),'</label>
   <input type="text" class="form-control" name="Phone2" id="Phone2" value="',$userRights->Phone2,'">
</div>
<div class="form-group">
   <label for="Phone3">',__("Phone 3"),'</label>
   <input type="text" class="form-control" name="Phone3" id="Phone3" value="',$userRights->Phone3,'">
</div>
<div class="form-group">
   <label for="Email">',__("Email Address"),'</label>
   <input type="text" class="form-control validate[optional,custom[email],condRequired[RackRequest]]" name="Email" id="Email" value="',$userRights->Email,'">
</div>
<div class="form-group">
   <label for="APIKey">',__("API Key"),'</label>
   <input type="text" class="form-control" size="60" name="APIKey" id="APIKey" value="',$userRights->APIKey,'" readonly>
</div>
<div class="form-group">
   <label for="NewKey">',__("Generate New Key"),'</label>
   <input name="NewKey" id="NewKey" type="checkbox">
</div>
<ul class="columns">
   <li><label>',__("Rights"),'</label></li>
   <li><input name="AdminOwnDevices" id="AdminOwnDevices" type="checkbox" ',$adminown,'><label for="AdminOwnDevices">',__("Admin Own Devices"),'</li>
    <li><input name="ReadAccess" id="ReadAccess" type="checkbox" ',$read,'><label for="ReadAccess">',__("Read/Report Access (Global)"),'</label></li>
    <li><input name="WriteAccess" id="WriteAccess" type="checkbox" ',$write,'><label for="WriteAccess">',__("Modify/Enter Devices (Global)"),'</label></li>
    <li><input name="DeleteAccess" id="DeleteAccess" type="checkbox" ',$delete,'><label for="DeleteAccess">',__("Delete Devices (Global)"),'</label></li>
    <li><input name="ContactAdmin" id="ContactAdmin" type="checkbox" ',$contact,'><label for="ContactAdmin">',__("Enter/Modify Contacts and Departments"),'</label></li>
    <li><input name="RackRequest" id="RackRequest" type="checkbox" ',$request,'><label for="RackRequest">',__("Enter Rack Requests"),'</label></li>
    <li><input name="RackAdmin" id="RackAdmin" type="checkbox" ',$RackAdmin,'><label for="RackAdmin">',__("Complete Rack Requests"),'</label></li>
    <li><input name="BulkOperations" id="BulkOperations" type="checkbox" ',$BulkOperations,'><label for="BulkOperations">',__("Perform Bulk Operations"),'</label></li>
    <li><input name="SiteAdmin" id="SiteAdmin" type="checkbox" ',$admin,'><label for="SiteAdmin">',__("Manage Site and Users"),'</label></li>
    <li><input name="Disabled" id="Disabled" type="checkbox" ',$Disabled,'><label for="Disabled">',__("Disabled"),'</label></li>	
   </ul>
</div>
<div class="caption" id="controls">';

	if($userRights->PersonID>0){
		echo '<button type="submit" name="action" class="btn btn-primary" value="Update">',__("Update"),'</button><button type="button" class="btn btn-primary" id="showdept">',__("Department Membership"),'</button><button class="hide btn btn-primary" id="transferdevices" type="button">',__("Transfer Devices"),'</button>';
	}else{
