...
class Device {
	...
	*/
	...
	function GetDeviceList( $datacenterid=null ) {
        ...
        // QUERY FUNCTION FOR DASHBOARD
        function GetDashDeviceList( $datacenterid=null ) {
		if ( $datacenterid == null ) {
			$dcLimit = "";
		} else {
			$dcLimit = "and b.DataCenterID=" . $datacenterid;
		...
		$sql = "SELECT a.* FROM fac_device a, fac_cabinet b WHERE a.Cabinet=b.CabinetID $dcLimit ORDER BY a.DeviceID DESC LIMIT 0,5";
  ...
  function GetDeviceDescendants() {
	...
	function SearchByCustomAttribute($searchTerm=null){
		...
		// Basic start of the query.
		$sql = "SELECT DISTINCT a.* FROM fac_device a, fac_devicecustomcvalue b WHERE a.DeviceID=b.DeviceID ";
