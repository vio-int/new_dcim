...
if (isset($_REQUEST['projectid']) && $_REQUEST['projectid'] != "") {
    ...
    <div class="form_container">
            ...
            <div class="col-sm-2"><label for="projectid">', __("Project Name:"), '</label></div>
            <div class="col-sm-4"><select name="projectid" id="projectid" onchange="this.form.submit()" class="form-control">
                <option value="">', __("Select Project"), '</option>
                <option value="all">', __("All Projects"), '</option>';
    foreach ($pList as $p) {
        print "\t\t\t\t<option value=\"$p->ProjectID\">$p->ProjectName</option>\n";
    }
    ?>
                        </select>
                    </div>
