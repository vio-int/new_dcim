...
if (isset($_POST["action"]) && (($_POST["action"] == "Create") || ($_POST["action"] == "Update"))) {
    ...
    if ($mfg->Name != null && $mfg->Name != "") {
        if ($_POST["action"] == "Create") {
            if ($mfg->CreateObject()) {
                header('Location: ' . redirect("cluster_type.php?PortID=$mfg->PortID"));
            } else {
...
$mfgList = $mfg->GetClusterTypeList();
        ...
        <script type="text/javascript">
            $(document).ready(function () {
                ...
                $('#PortID').change(function (e) {
                    location.href = 'cluster_type.php?PortID=' + this.value;
                });
                ...
                <div class="row">
                    <div class="col-sm-12 col-md-12">
                        <ol class="breadcrumb">
                            ...
                            <li><a href="cluster_type_list.php">Cluster Type</a></li>
                            <li><?php echo $mfg->PortID!=""?'Edit':'Add';?> Cluster Type</li>
                        </ol>
                    </div>
                </div>
                <!-- Breadcrumb code end -->
...
<div class="panel panel-default">
    <div class="panel-heading"><strong>Cluster Type</strong></div>
    ...
    <div class="form-group">
       ...
       <option value=0>', __("Type Name"), '</option>';
...
<div class="text-center">';
                    ...
                    echo '&nbsp;<a href="cluster_type_list.php" class="btn-panel btn-success">',__("Cancel"),'</a>';
                    ?>
                </div>
            </div>
        </div>
